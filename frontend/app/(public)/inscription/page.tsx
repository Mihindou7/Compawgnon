    ...
    <main className="flex min-h-screen items-center justify-center bg-surface-cream px-4 py-12">
      <div className="w-full max-w-md animate-slide-up">
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <h1 className="font-serif text-3xl text-text-ink">Créer un compte</h1>
          <p className="text-sm text-text-subtle">Rejoignez la communauté Compawgnon</p>
        </div>
